...
class TestVectorSum(ExtTestCase):
    def test_vector_sum_c(self):
        from teachcompute.validation.cython.vector_function_cy import vector_sum_c
    ...
    def test_vector_sum(self):
        from teachcompute.validation.cpu._validation import vector_sum
    ...
    def test_vector_sum_array(self):
        from teachcompute.validation.cpu._validation import vector_sum_array
    ...
    def test_vector_sum_array_avx(self):
        from teachcompute.validation.cpu._validation import vector_sum_array_avx
    ...
    def test_vector_add_exc(self):
        from teachcompute.validation.cpu._validation import vector_add
    ...
    def test_vector_add_c(self):
        from teachcompute.validation.cython.vector_function_cy import vector_add_c
