...
cdef extern from "experiment_cython_.h":
    ...
    cdef void filter_dmax2(double *p1, cython.int size, double mx) nogil
    cdef void filter_dmax16(double *p1, cython.int size, double mx) nogil
    cdef void filter_dmax4(double *p1, cython.int size, double mx) nogil
