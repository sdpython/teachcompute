...
cdef extern from "dot_cython_.h":
    cdef double vector_ddot_product_pointer16(
        const double *p1, const double *p2, cython.int size) nogil
    cdef double vector_ddot_product_pointer16_sse(
        const double *p1, const double *p2, cython.int size) nogil
    cdef float vector_sdot_product_pointer16(
        const float *p1, const float *p2, cython.int size) nogil
    cdef float vector_sdot_product_pointer16_sse(
        const float *p1, const float *p2, cython.int size) nogil
