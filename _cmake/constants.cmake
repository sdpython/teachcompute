...
message(STATUS "TEACHCOMPUTE_VERSION=${TEACHCOMPUTE_VERSION}")
...
message(STATUS "TORCH_API_INCLUDE_EXTENSION_H=${TORCH_API_INCLUDE_EXTENSION_H}")
message(STATUS "PYBIND11_BUILD_ABI=${PYBIND11_BUILD_ABI}")
...
if(APPLE)
  # set(DEFAULT_OSX_DEPLOYMENT_TARGET "12.0")  # work for compilation but OrtSession fails
...
if (PYTHON_MANYLINUX EQUAL "1")
  ...
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Wno-unknown-pragmas -Wextra -O3")
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Wno-unknown-pragmas -Wextra -O3")
  if(APPLE)
...
if(APPLE)
  ...
  if (CMAKE_OSX_DEPLOYMENT_TARGET STREQUAL "")
    message(ERROR "CMAKE_OSX_DEPLOYMENT_TARGET cannot be empty, "
                  "DEFAULT_OSX_DEPLOYMENT_TARGET='${DEFAULT_OSX_DEPLOYMENT_TARGET}'")
  endif()
endif()
message(STATUS "**********************************")
message(STATUS "**********************************")
