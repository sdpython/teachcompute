...
inline DTYPE& at(DTYPE* p, int cols, int i, int j) { return mat[i * cols + j]; }
...
template <tynename DTYPE>
void BlockMatrixMultiply(const DTYPE* A, const DTYPE* B, DTYPE* C, int n, int m, int p, int block_size) {
